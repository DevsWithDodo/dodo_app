...
class ImShoppingDialog extends StatefulWidget {
  const ImShoppingDialog({super.key});

  @override
  State<ImShoppingDialog> createState() => _ImShoppingDialogState();
}
                  ...
                  GradientButton(
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        showFutureOutputDialog(context: context, future: _postImShopping(store), outputCallbacks: {
